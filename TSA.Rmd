...
## Another nonparametric test that we can use to test whether our samples originate from the same distribution is the Kruskal Wallis test [2]. This test does not assume that our samples have equal variance or are normally distributed. This test will do well to tell us if the medians of both samples are statistically significantly different, and thus if we can reject the null hypothesis.
